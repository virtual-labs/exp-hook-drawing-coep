			...
			<div class="heading" style="background-color:#425c64; border-radius: 25px; margin-top: 10px;">
              ...
              <div class="container-fluid mt-3">
                <div class="row">
                   ...
                   <div class="col-6">
                        <div class="component" draggable="true" data-type="pressuredotValve">
                            <img src="images/pressuredotValve.png" alt="pressuredotValve" draggable="false">
                        </div>
                    </div>
                   
                   <div class="col-6">
                        <div class="component" draggable="true" data-type="pressureValve">
                            <img src="images/pressureValve.png" alt="pressureValve" draggable="false">
                        </div>
                    </div>
...
//	                <option value="Gate Valve">Gate Valve</option>
	...
	const randomizedDescriptions3 = shuffleArray3(descriptions3);
	
	renderShuffledOptions3 = function() { 
		
		var htm = `<option>----Select---- </option>`
					for(z = 0; z < randomizedDescriptions3.length; z++){
						htm+=`<option value='`+randomizedDescriptions3[z]+`'>`+randomizedDescriptions3[z]+`</option>`
					}		
    ...
    let validData = [
        { "srNo": "1", "description": "Globe Valve", "qty": 2 },
        { "srNo": "2", "description": "Gate Valve", "qty": 2 },
 ...
 $("#resultBtn").click(function () {
    ...
    if (validationErrors.length > 0) {
        // Count this as one invalid attempt
        tabCntIP++;
        ...
        if (tabCntIP <= 3) {
            ...
            Swal.fire({
                ...
                html: `<div>
                            <img src='images/highServiceBom.png' class='img-fluid' 
        ...
        resultJson.pressureService = pressureService;
