...
var x=100;y=10;
   ...
   var rectPlate = paper.rect((x+241.5),(y-18),7,15).attr({"fill":"#807d7d"});
	...
	var txt = paper.text((x+301.1),(y+39.9)," 1 ").attr({"font-size": 10,"font-family": "Arial","font-weight": "bold", 
	...
	var txt = paper.text((x+415),(y+60)," 2 ").attr({"font-size": 10,"font-family": "Arial","font-weight": "bold", 
	 "fill": "#4d4949","text-anchor": "middle"}).toFront();
}
	...
	var txt = paper.text((x+376),(y+225)," 3 ").attr({"font-size": 10,"font-family": "Arial","font-weight": "bold", 
	 "fill": "#4d4949","text-anchor": "middle"}).toFront();
}
   ...
   //circle 4
	...
	var txt = paper.text((x+333),(y+290)," 4 ").attr({"font-size": 10,"font-family": "Arial","font-weight": "bold", 
	 "fill": "#4d4949","text-anchor": "middle"}).toFront();
	  
   //circle 5 
   
    var cir5 = paper.circle((x+302),(y-28),7.5).attr({"stroke":"#615757"});
	var txt5 = paper.text((x+302),(y-28)," 5 ").attr({"font-size": 10,"font-family": "Arial","font-weight": "bold", 
	 "fill": "#4d4949","text-anchor": "middle"}).toFront();	 
	...
	var txt6 = paper.text((x+42),(y+235)," 6 ").attr({"font-size": 10,"font-family": "Arial","font-weight": "bold", 
	 "fill": "#4d4949","text-anchor": "middle"}).toFront();
	...
	var txt7 = paper.text((x+42),(y+140)," 7 ").attr({"font-size": 10,"font-family": "Arial","font-weight": "bold", 
	 "fill": "#4d4949","text-anchor": "middle"}).toFront();
   ...
   title: 'Appropriate Connections',
    ...
    confirmButtonText: 'Try Again',
     customClass: {
        ...
        resultJson.mimicCount=mimicCount;
